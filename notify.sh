...
git remote add github https://$GITHUB_TOKEN@github.com/qianzm2490@vip.qq.com/iview-tree-transfer.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/qianzm2490@vip.qq.com/iview-tree-transfer/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "iview-tree-transfer更新", "text": "@所有人\n# [iview-tree-transfer('$version')]('$html_url')\n'$body'"}}'
